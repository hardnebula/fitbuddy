          ...
          >
            <View style={styles.content}>
              <Image
                ...
                resizeMode="contain"
              />
              <Text style={[styles.title, { color: colors.text }]}>What kind of exercise do you usually do?</Text>
              <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Just to personalize your experience.</Text>
