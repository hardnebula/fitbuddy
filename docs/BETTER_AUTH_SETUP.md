...
npx convex env set APPLE_APP_BUNDLE_IDENTIFIER=com.yourcompany.fitbuddy  # Optional, for iOS
```
...
3. For production, ensure your app's scheme matches `fitbuddy://` in your `app.json`
